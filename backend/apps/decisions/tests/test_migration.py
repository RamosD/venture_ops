"""Teste da migração inicial do módulo decisions (aplica, reverte, sem drift)."""
...
TABLE = "decisions_decision"


class DecisionsMigrationTests(TransactionTestCase):
    ...
    def test_migration_applies_and_reverts(self):
        ...
        self._migrate([("decisions", None)])
        self.assertFalse(self._table_exists())
        self._migrate([("decisions", "0001_initial")])
        self.assertTrue(self._table_exists())
