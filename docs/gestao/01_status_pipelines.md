...
| F1-P03 | F1 | Portefólio e ficha do produto | Concluído | Não revista | 6 | 6 | 0 | 0 | — (commit `303d741`) |
| F1-P04 | F1 | Documentos, tipos, decisões e pendências | Concluído | Não revista | 6 | 6 | 0 | 0 | — (commit de F1-P04; gerar F1-P05) |
